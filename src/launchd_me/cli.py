...
def get_args():
    ...
    parser_create.add_argument(
        ...
        help="schedule_type. 'interval' schedules are defined seconds. 'calendar' schedules are defined usings times, days, weeks etc. See Documentation for more details.",
    )
    parser_create.add_argument(
        "schedule_details",
    ...
    parser_create.add_argument(
        ...
        "--auto-install",
        default=True,
        help="Automatically load the plist file once created. Defaults to True.",
    )
    parser_create.add_argument(
        "-m",
        "--make-executable",
        default=True,
        help="Check if the specified script is already an executable and, if it is not, make it exectuable. Defaults to True.",
    )
